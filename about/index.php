...
<head>
  ...
  <title>About - Dalil Al-Enzar</title>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-9 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-offset-1 col-sm-10">
        <h1 class="title">About - Dalil Al-Enzar</h1>
        <p class="p-b-15">Dalil Alarm for Safety Tools and Materials is a supplier  in providing inspection, testing and maintenance of all fire protection activities and systems.</p>
<?php  
require_once("../admin/connection.php");
$sql = "SELECT * FROM tbl_achievements order by achievement_ID desc";
$result = mysqli_query($conn, $sql);
if (mysqli_num_rows($result) > 0) {
  echo '<h2 class="title">Achievements</h2>';
  while ($row = mysqli_fetch_assoc($result)) {
    $achievement_title_en = $row['achievement_title_en'];
    $achievement_pdf = $row['achievement_pdf'];
    if ($achievement_pdf != null) {
      $achievement_pdf = '<a href="../admin/'.$achievement_pdf.'" target="_blank">View Details</a>';
    }else{
      $achievement_pdf = '<i>--</i>';
    }
    echo '<div class="row">';
      echo '<div class="col-md-12">';
        echo '<div class="award-box">';
          echo '<h4 class="title">'.$achievement_title_en.'</h4>';
          echo $achievement_pdf;
        echo '</div>';
      echo '</div>';
    echo '</div>';
  }
    ...
    <div class="row">
      ...
      <div class="col-md-2 col-sm-4">
        <div class="footer-nav-box">
          ...
          <a href="" title="About" class="footer-links">
